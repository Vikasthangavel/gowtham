...
const projects = [
  ...
  { id: 10, img: pranavaImg, title: 'Pranava Catering', url: 'https://pranava.netlify.app/', tag: 'Food', desc: 'Catering service website with menu showcases, event gallery, and inquiry forms.' },
  ...
  { id: 3, img: planetBrandingsImg, title: 'Planet Brandings', url: 'https://planetbrandings.com/', tag: 'Branding', desc: 'Creative branding agency website showcasing brand identity, design services, and portfolio.' },
  { id: 12, img: foreverImg, title: 'Forever Finds', url: 'https://forever-find.netlify.app/', tag: 'E-Commerce', desc: 'E-commerce platform for unique products with cart, filters, and smooth shopping UX.' },
  { id: 13, img: jbsImg, title: 'Jayalakshmi Borewells', url: 'https://jayalakshmiborewells.netlify.app/', tag: 'Services', desc: 'Borewell services website with project portfolio and quick contact functionality.' },
  { id: 14, img: aghavanImg, title: 'Aghavan Foundation', url: 'https://aghavan.org/', tag: 'NGO', desc: 'Foundation website for social welfare initiatives with events and volunteer registration.' },
  { id: 15, img: aghanImg, title: 'Aghan Promoters', url: 'https://testing-aghan.netlify.app/', tag: 'Real Estate', desc: 'Real estate promoters website with property listings, enquiry forms, and location maps.' },
];
